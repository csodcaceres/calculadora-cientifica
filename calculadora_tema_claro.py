...
class CalculadoraGUITemaClaro:
    def __init__(self, root):
        self.root = root
        self.root.title("Calculadora Científica - Tema Claro")
    ...
    def _crear_interfaz(self):
        ...
        estilo_boton_operacion["bg"] = "#FF9966"  # Melocotón
        estilo_boton_operacion["fg"] = "#333333"  # Texto oscuro
        
        estilo_boton_numero = estilo_boton.copy()
        estilo_boton_numero["bg"] = "#E6E6FA"  # Lavanda
        estilo_boton_numero["fg"] = "#333333"  # Texto oscuro
        
        estilo_boton_igual = estilo_boton.copy()
        estilo_boton_igual["bg"] = "#90EE90"  # Verde claro
        estilo_boton_igual["fg"] = "#333333"  # Texto oscuro
        
        estilo_boton_borrar = estilo_boton.copy()
        estilo_boton_borrar["bg"] = "#FFC0CB"  # Rosa claro
        estilo_boton_borrar["fg"] = "#333333"  # Texto oscuro
        
        estilo_boton_funcion = estilo_boton.copy()
        estilo_boton_funcion["bg"] = "#ADD8E6"  # Azul claro
        estilo_boton_funcion["fg"] = "#333333"  # Texto oscuro
        
        estilo_boton_memoria = estilo_boton.copy()
        estilo_boton_memoria["bg"] = "#D8BFD8"  # Cardo
        estilo_boton_memoria["fg"] = "#333333"  # Texto oscuro
    ...
    # El resto del código es idéntico a calculadora_gui_simple.py
...
def main():
    root = tk.Tk()
    app = CalculadoraGUITemaClaro(root)
    root.mainloop()
